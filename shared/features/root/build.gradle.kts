...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.shared.features.display)
            implementation(projects.shared.features.menu)
            implementation(projects.shared.features.record)
            implementation(projects.shared.features.role)
